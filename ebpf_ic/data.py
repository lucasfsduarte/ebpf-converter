...
# *
# *  Description:
# *        Storing data structure that keep info about ebpf statements
# *
...
# List of possible arguments and its respective description
args_set = {

    'data': {
        '--hex':    {'description': 'Generates machine language in hexadecimal', 'value': True},
        '--bin':    {'description': 'Generates machine language in binary', 'value': False}
    },
    'instruction': {
        '--apart':  {'description': 'Generates two values (high and low) as the final instruction', 'value': True},
        '--unique': {'description': 'Generates a single value as the final instruction', 'value': False}
    }
}

# List of eBPF registers and its correspondent in binary
reg_set = {
...
# List of eBPF x64 and x32 instructions and its correspondent opcode:
x64_x32_inst_set = {
...
# List of eBPF byteswap instructions and its correspondent opcode:
byteswap_inst_set = {
...
# List of eBPF memory access instructions and its correspondent opcode:
memory_inst_set = {
...
# List of eBPF branch instructions and its correspondent opcode:
branch_inst_set = {
    'ja'   : {'opcode': '00000101'},
